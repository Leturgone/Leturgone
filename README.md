...
| | |
| --- | --- |
|<img src="https://github.com/tandpfun/skill-icons/blob/main/icons/Kotlin-Dark.svg" width="20" height="20" alt="JavaScript" /> ![ListingsToWordConverter](https://github.com/Leturgone/ListingsToWordConverter)<br>Simple KMP app, wich allows to convert code to Microsoft Word file with tables <br> `KMP` `Clean Architecture` `MVI` `Compose Multiplatform` `Apache POI OOXML` `Koin` `Okio` | 
